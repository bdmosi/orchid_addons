...
#             self.od_date_set = True
    ...
    od_amended_profit = fields.Float(string="Amended Sale Profit",compute="od_get_total_sale_value",digits=dp.get_precision('Account'))
