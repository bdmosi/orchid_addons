...
class od_cost_sheet(models.Model):
    ...
    def cron_od_cost_sheet(self, cr, uid, context=None):
        ...
        for company_id in [1,6]:
            remind = []
            fill_remind([('po_status', '!=', 'available'),('company_id','=',company_id),('state','not in',('draft','submitted','cancel'))])
...
<h5 style="direction: rtl; text-align: right;">خدمات التشغيل بواسطة مهندسين / موظفين مقيمين لدى العميل</h5>
    ...
    od_version = fields.Char(string="Version",states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)]},readonly=True)
    project_manager = fields.Many2one('res.users','Project Manager',states={'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)]},readonly=True,track_visibility='always')
    support_doc_line = fields.One2many('od.support.doc.line','cost_sheet_id',string='Support Doc Lin',copy=True,states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'analytic_change':[('readonly',False)]},readonly=True)
    deadlines = fields.One2many('od.deadlines','cost_sheet_id',string='Deadlines',copy=True,default=default_dead_line_data,states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'processed':[('readonly',False)],'analytic_change':[('readonly',False)]},readonly=True)
    payment_schedule_line = fields.One2many('od.payment.schedule','cost_sheet_id',string='Payment Schedule',copy=True,states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'processed':[('readonly',False)],'analytic_change':[('readonly',False)],'change':[('readonly',False)]},readonly=True)
    comm_matrix_line = fields.One2many('od.comm.matrix','cost_sheet_id',string='Communication Matrix',copy=True,states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'processed':[('readonly',False)],'change':[('readonly',False)],'analytic_change':[('readonly',False)]},readonly=True)
...
#             self.bim_log_vat_value = self.bim_log_price * bim_tax_id.amount
    ...
    cost_section_line = fields.One2many('od.cost.section.line','cost_sheet_id',string='Cost Section Line',copy=True,states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,default=default_section_material)
    cost_section_option_line = fields.One2many('od.cost.opt.section.line','cost_sheet_id',string='Cost Section Line',copy=True,states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,default=default_section_optional)
    cost_section_trn_line = fields.One2many('od.cost.trn.section.line','cost_sheet_id',string='Cost Section Line',copy=True,states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,default=default_section_training)
    costgroup_it_service_line = fields.One2many('od.cost.costgroup.it.service.line','cost_sheet_id',string='Cost Costgroup It Service Line',copy=True,default=default_beta_service_line,states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True)
    costgroup_material_line = fields.One2many('od.cost.costgroup.material.line','cost_sheet_id',string='Cost Costgroup Material Line',copy=True,states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,default=default_costgroup_material_line)
    costgroup_extra_expense_line = fields.One2many('od.cost.costgroup.extra.expense.line','cost_sheet_id',string='Cost Costgroup Material Line',copy=True,states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,default=default_costgroup_extra_expense_line)
    costgroup_optional_line = fields.One2many('od.cost.costgroup.optional.line.two','cost_sheet_id',string='Cost Costgroup Optional Line',copy=True,states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,default=default_costgroup_optional_line)
    mat_main_pro_line = fields.One2many('od.cost.mat.main.pro.line','cost_sheet_id',string='Mat Main Proposal Line',states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,copy=True)
    mat_optional_item_line = fields.One2many('od.cost.mat.optional.item.line','cost_sheet_id',string='Mat Optional Line',states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,copy=True)
    ...
    mat_extra_expense_line = fields.One2many('od.cost.mat.extra.expense.line','cost_sheet_id',string='Mat Extra Expense Line',states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,copy=True)
...
\n* Electronic Licenses and Manufacturer Services will not be delivered as part of the material because they only represent codes which will be activated at the vendor site.")
    ...
    ren_main_pro_line = fields.One2many('od.cost.ren.main.pro.line','cost_sheet_id',string='Ren Main Proposal Line',copy=True,states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True)
    ren_optional_item_line = fields.One2many('od.cost.ren.optional.item.line','cost_sheet_id',string='Ren Optional Line',copy=True,states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True)
    bmn_eqp_cov_line = fields.One2many('od.bmn.eqp.cov.line','cost_sheet_id',string='BMN Equipment Covered by The Scope of Service',copy=True,states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True)
    omn_eqp_cov_line = fields.One2many('od.omn.eqp.cov.line','cost_sheet_id',string='OMN Equipment Covered by The Scope of Service',copy=True,states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True)
    o_m_eqp_cov_line = fields.One2many('od.o_m.eqp.cov.line','cost_sheet_id',string='OM Equipment Covered by The Scope of Service',copy=True,states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True)
    bim_implementation_code_line = fields.One2many('od.cost.bim.beta.implementation.code','cost_sheet_id',string='Bim Implementation Code Line',copy=True,states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True)
    ...
    trn_customer_training_extra_expense_line = fields.One2many('od.cost.trn.customer.training.extra.expense.line','cost_sheet_id',string='Trn Customer Extra Expense Line',copy=True,states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True)
    ...
    implimentation_extra_expense_line = fields.One2many('od.cost.bim.beta.implimentation.extra.expense.line','cost_sheet_id',string='Bim Extra Expense Line',states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,copy=True)
    manpower_manual_line = fields.One2many('od.cost.bim.beta.manpower.manual.line','cost_sheet_id',string='Bim Manpower Manual Line',states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,copy=True)
    #OIM
    ...
    oim_implimentation_price_line = fields.One2many('od.cost.oim.implimentation.price.line','cost_sheet_id',string='Oim Implimentation Price Line',states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,copy=True)
    oim_extra_expenses_line = fields.One2many('od.cost.oim.extra.expenses.line','cost_sheet_id',string='Oim Extra Expense Line',states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,copy=True)
    #o&m
    ...
    om_residenteng_line = fields.One2many('od.cost.om.residenteng.line','cost_sheet_id',string='Om Resident Eng Line',states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,copy=True,default=default_resident_eng_line)
    show_om_eqpmntreqst_cust = fields.Boolean(string='Show to Customer',default=False)
    om_eqpmentreq_line = fields.One2many('od.cost.om.eqpmentreq.line','cost_sheet_id',string='Om Equipment Request Line',states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,copy=True)
    ...
    om_extra_line = fields.One2many('od.cost.om.extra.line','cost_sheet_id',string='Om Extra Line',states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,copy=True)
    #OMN
...
#     omn_year = fields.Selection([(num, str(num)) for num in range(1990, (datetime.now().year)+1 )], 'Year')
    ...
    omn_spare_parts_line = fields.One2many('od.cost.omn.spare.parts.line','cost_sheet_id',string='Omn Spare Parts Line',states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,copy=True)
    omn_maintenance_extra_expense_line = fields.One2many('od.cost.omn.maintenance.extra.expense.line','cost_sheet_id',string='Omn Extra Expense Line',states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,copy=True)
    #BMN
...
#     bmn_year = fields.Selection([(num, str(num)) for num in range(1990, (datetime.now().year)+1 )], 'Year')
    ...
    bmn_spareparts_beta_it_maintenance_line = fields.One2many('od.cost.bmn.spareparts.beta.it.maintenance.line','cost_sheet_id',string='Bmn Spareparts Line',states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,copy=True)
    bmn_beta_it_maintenance_extra_expense_line = fields.One2many('od.cost.bmn.beta.it.maintenance.extra.expense.line','cost_sheet_id',string='Bmn Extra Expense Line',states={'draft':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,copy=True)
