...
#     owner_id_a0 = fields.Many2one('res.users',string="Owner A0")
    ...
    periodicity = fields.Selection([('monthly','Monthly'),('quarterly','Quarterly'),('yearly','Yearly')],string="Periodicity")
    no_of_l2_accounts = fields.Integer(string="No.of L2 Accounts")
    l2_start_date = fields.Date(string="Start Date")
    ...
    support_doc_line = fields.One2many('od.support.doc.line','cost_sheet_id',string='Support Doc Lin',copy=True,states={'draft':[('readonly',False)],'design_ready':[('readonly',False)],'submitted':[('readonly',False)],'commit':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'waiting_po':[('readonly',False)],'change':[('readonly',False)],'analytic_change':[('readonly',False)]},readonly=True)
    deadlines = fields.One2many('od.deadlines','cost_sheet_id',string='Deadlines',copy=True,default=default_dead_line_data,states={'draft':[('readonly',False)],'design_ready':[('readonly',False)],'submitted':[('readonly',False)],'commit':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'waiting_po':[('readonly',False)],'change':[('readonly',False)],'change_processed':[('readonly',False)],'waiting_po_processed':[('readonly',False)],'processed':[('readonly',False)],'analytic_change':[('readonly',False)]},readonly=True)
    payment_schedule_line = fields.One2many('od.payment.schedule','cost_sheet_id',string='Payment Schedule',copy=True,states={'draft':[('readonly',False)],'design_ready':[('readonly',False)],'submitted':[('readonly',False)],'commit':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'waiting_po':[('readonly',False)],'processed':[('readonly',False)],'change_processed':[('readonly',False)],'waiting_po_processed':[('readonly',False)],'analytic_change':[('readonly',False)],'change':[('readonly',False)]},readonly=True)
    comm_matrix_line = fields.One2many('od.comm.matrix','cost_sheet_id',string='Communication Matrix',copy=True,states={'draft':[('readonly',False)],'design_ready':[('readonly',False)],'submitted':[('readonly',False)],'commit':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'waiting_po':[('readonly',False)],'processed':[('readonly',False)],'change_processed':[('readonly',False)],'waiting_po_processed':[('readonly',False)],'change':[('readonly',False)],'analytic_change':[('readonly',False)]},readonly=True)
...
#             self.bim_log_vat_value = self.bim_log_price * bim_tax_id.amount
    ...
    cost_section_line = fields.One2many('od.cost.section.line','cost_sheet_id',string='Cost Section Line',copy=True,states={'draft':[('readonly',False)],'design_ready':[('readonly',False)],'submitted':[('readonly',False)],'commit':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'waiting_po':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,default=default_section_material)
    cost_section_option_line = fields.One2many('od.cost.opt.section.line','cost_sheet_id',string='Cost Section Line',copy=True,states={'draft':[('readonly',False)],'design_ready':[('readonly',False)],'submitted':[('readonly',False)],'commit':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'waiting_po':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,default=default_section_optional)
    cost_section_trn_line = fields.One2many('od.cost.trn.section.line','cost_sheet_id',string='Cost Section Line',copy=True,states={'draft':[('readonly',False)],'design_ready':[('readonly',False)],'submitted':[('readonly',False)],'commit':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'waiting_po':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,default=default_section_training)
    costgroup_it_service_line = fields.One2many('od.cost.costgroup.it.service.line','cost_sheet_id',string='Cost Costgroup It Service Line',copy=True,default=default_beta_service_line,states={'draft':[('readonly',False)],'design_ready':[('readonly',False)],'submitted':[('readonly',False)],'commit':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'waiting_po':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True)
    costgroup_material_line = fields.One2many('od.cost.costgroup.material.line','cost_sheet_id',string='Cost Costgroup Material Line',copy=True,states={'draft':[('readonly',False)],'design_ready':[('readonly',False)],'submitted':[('readonly',False)],'commit':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'waiting_po':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,default=default_costgroup_material_line)
    costgroup_extra_expense_line = fields.One2many('od.cost.costgroup.extra.expense.line','cost_sheet_id',string='Cost Costgroup Material Line',copy=True,states={'draft':[('readonly',False)],'design_ready':[('readonly',False)],'submitted':[('readonly',False)],'commit':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'waiting_po':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,default=default_costgroup_extra_expense_line)
    costgroup_optional_line = fields.One2many('od.cost.costgroup.optional.line.two','cost_sheet_id',string='Cost Costgroup Optional Line',copy=True,states={'draft':[('readonly',False)],'design_ready':[('readonly',False)],'submitted':[('readonly',False)],'commit':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'waiting_po':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,default=default_costgroup_optional_line)
...
\n* Electronic Licenses and Manufacturer Services will not be delivered as part of the material because they only represent codes which will be activated at the vendor site.")
    ...
    om_residenteng_line = fields.One2many('od.cost.om.residenteng.line','cost_sheet_id',string='Om Resident Eng Line',states={'draft':[('readonly',False)],'design_ready':[('readonly',False)],'submitted':[('readonly',False)],'commit':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'waiting_po':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,copy=True,default=default_resident_eng_line)
...
#     bmn_year = fields.Selection([(num, str(num)) for num in range(1990, (datetime.now().year)+1 )], 'Year')
    ...
    bmn_it_preventive_line = fields.One2many('od.cost.bmn.it.preventive.line','cost_sheet_id',string='Bmn It Preventive Line',states={'draft':[('readonly',False)],'design_ready':[('readonly',False)],'submitted':[('readonly',False)],'commit':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'waiting_po':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,copy=True,default=default_bmn_it_preventive_line)
    show_bmn_it_remedial_line = fields.Boolean(string='Show to Customer',default=False)
    bmn_it_remedial_line = fields.One2many('od.cost.bmn.it.remedial.line','cost_sheet_id',string='Bmn It Remedial Line',states={'draft':[('readonly',False)],'design_ready':[('readonly',False)],'submitted':[('readonly',False)],'commit':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'waiting_po':[('readonly',False)],'change':[('readonly',False)],'modify':[('readonly',False)]},readonly=True,copy=True,default=default_bmn_it_remedial_line)
...
#             self.vat = self.group2.vat
    ...
    vat = fields.Float(string="VAT %",digits=dp.get_precision('Account'))
    vat_value = fields.Float(sttring="VAT Value",compute="_compute_vat",digits=dp.get_precision('Account'))
    vat_value2 = fields.Float(sttring="VAT Value",compute="_compute_vat",digits=dp.get_precision('Account'))
#     @api.one 
...
#             unit_price = (unit_cost / (1-profit)) - (unit_cost * discount)
    ...
    tax_id = fields.Many2one('account.tax',string="Tax",digits=dp.get_precision('Account'))
    vat = fields.Float(string="VAT %",compute='_compute_vat',digits=dp.get_precision('Account'))
    vat_value = fields.Float(string="VAT Value",compute='_compute_vat',digits=dp.get_precision('Account'))
