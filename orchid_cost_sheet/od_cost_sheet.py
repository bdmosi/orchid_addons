...
<h5 style="direction: rtl; text-align: right;">خدمات التشغيل بواسطة مهندسين / موظفين مقيمين لدى العميل</h5>
    ...
    deadlines = fields.One2many('od.deadlines','cost_sheet_id',string='Deadlines',copy=True,default=default_dead_line_data,states={'draft':[('readonly',False)],'design_ready':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'change':[('readonly',False)],'change_processed':[('readonly',False)],'waiting_po_processed':[('readonly',False)],'processed':[('readonly',False)],'analytic_change':[('readonly',False)]},readonly=True)
    payment_schedule_line = fields.One2many('od.payment.schedule','cost_sheet_id',string='Payment Schedule',copy=True,states={'draft':[('readonly',False)],'design_ready':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'processed':[('readonly',False)],'change_processed':[('readonly',False)],'waiting_po_processed':[('readonly',False)],'analytic_change':[('readonly',False)],'change':[('readonly',False)]},readonly=True)
    comm_matrix_line = fields.One2many('od.comm.matrix','cost_sheet_id',string='Communication Matrix',copy=True,states={'draft':[('readonly',False)],'design_ready':[('readonly',False)],'submitted':[('readonly',False)],'returned_by_pmo':[('readonly',False)],'returned_by_fin':[('readonly',False)],'handover':[('readonly',False)],'processed':[('readonly',False)],'change_processed':[('readonly',False)],'waiting_po_processed':[('readonly',False)],'change':[('readonly',False)],'analytic_change':[('readonly',False)]},readonly=True)
