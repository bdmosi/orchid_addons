...
class website_hr_recruitment(http.Controller):
    ...
    def jobs_thankyou(self, **post):
        ...
        for f in ['email_from', 'partner_name', 'description','dob','age','qualification','gender','specialization','experience','year','college','university','workedat','roll','workexp','notice_period','current_ctc','expected_ctc','current_location','skills']:
            value[f] = post.get(f)
