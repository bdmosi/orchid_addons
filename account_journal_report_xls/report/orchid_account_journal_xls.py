...
from .orchid_account_journal import orchid_journal_print
from openerp.tools.translate import _
import logging
_logger = logging.getLogger(__name__)


class account_journal_xls_parser(orchid_journal_print):
...
account_journal_xls('report.orchid.account.journal.xls', 'account.journal.period',
