...
_ir_translation_name = 'orchid.account.journal.print'


class orchid_journal_print(report_sxw.rml_parse):

    def set_context(self, objects, data, ids, report_type=None):
        #_logger.warn('set_context, objects = %s, data = %s, ids = %s', objects, data, ids)
        super(orchid_journal_print, self).set_context(objects, data, ids)
    ...
    def __init__(self, cr, uid, name, context):
        if context is None:
            context = {}
        super(orchid_journal_print, self).__init__(cr, uid, name, context=context)
    ...
    def formatLang(self, value, digits=None, date=False, date_time=False, grouping=True, monetary=False, dp=False, currency_obj=False):
        if isinstance(value, (float, int)) and not value:
            ...
            return super(orchid_journal_print, self).formatLang(value, digits, date, date_time, grouping, monetary, dp, currency_obj)

report_sxw.report_sxw('report.orchid.account.journal.print', 'account.journal',
    'addons/account_journal_report_xls/report/orchid_account_journal.rml',
    parser=orchid_journal_print, header=False)
