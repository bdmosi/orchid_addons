...
class account_invoice(models.Model):
    ...
    def get_gov_section(self):
        ...
        for line in self.gov_alternate_line:
            res.append({'name':line.name + ' _ '+ line.name2,'section':line.section2 or 'Uncategorized','quantity':line.quantity,'unit_price':line.unit_price,'total_bf_tax':line.total_bf_tax,'tax_rate':line.tax_rate,'tax_amount':line.tax_amount,'total_amount':line.total_amount})
